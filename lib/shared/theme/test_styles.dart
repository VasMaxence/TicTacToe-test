...
abstract class AppTextStyles {
  ...
  static TextStyle titleStyle(double fontSize, {FontWeight weight = FontWeight.w400, TextDecoration? decoration}) =>
      defaultStyle(AppColors.white, fontSize, weight: weight, decoration: decoration);

  static TextStyle bodyStyle(double fontSize, {FontWeight weight = FontWeight.w400, TextDecoration? decoration}) =>
      defaultStyle(AppColors.white, fontSize, weight: weight, decoration: decoration);
}
